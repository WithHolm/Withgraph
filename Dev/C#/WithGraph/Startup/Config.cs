...
namespace WithGraph
{
    ...
    public class GetConfig : PSCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            WriteObject(JsonConvert.DeserializeObject<Settingsroot>(GraphSettings.Read()));
            base.ProcessRecord();
        }
    ...
    public class GraphSettings
    {
        ...
        {   
            ...
            string Return = File.ReadAllText(Enviorment.ConfigFile);
            return Return;
        }
        ...
        private static void Create()
        {
            ...
            string Config = File.ReadAllText(Encoding.UTF8.GetString(Properties.Resources.ConfigTemplate));
            File.WriteAllText(Enviorment.ConfigFile, Config);
        }
    }

    public static class SessionID
    {
        Guid _sessionID { get; set; }
        SessionID()
        {
            _sessionID = new Guid();
        }
